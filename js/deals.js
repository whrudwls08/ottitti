window.KKUNSUB_DEALS = {
  ...
  bundles: [
    ...
    },
    {
      ...
      planNote: "스탠다드 결합 · 요금제 할인 전 참고가",
      price: 13900,
      sourceLabel: "T world",
      sourceUrl: "https://m.tworld.co.kr/product/callplan?prod_id=NA00009795",
      evidence: "official",
    },
    {
      id: "skt-tving-wavve-ad",
      name: "T 우주패스 티빙&웨이브 (광고형)",
      kind: "partner",
      includes: ["tving_ad", "wavve"],
      planNote: "광고형 결합 · 요금제 할인 전 참고가",
      price: 6500,
      sourceLabel: "T world",
      sourceUrl: "https://m.tworld.co.kr/product/callplan?prod_id=NA00009795",
      evidence: "official",
    },
    {
      ...
      kind: "partner",
      includes: ["disney"],
      planNote: "스탠다드 · LG U+ 유독 (통신사 무관 가입 가능)",
      price: 9405,
      sourceLabel: "LG U+ 유독",
      sourceUrl: "https://www.lguplus.com/pogg/product/%EB%94%94%EC%A6%88%EB%8B%88%ED%94%8C%EB%9F%AC%EC%8A%A4-%EC%9B%94%EC%A0%95%EC%95%A1-%EA%B5%AC%EB%8F%85",
      evidence: "official",
    },
    {
      id: "udeok-tving",
      ...
      kind: "partner",
      includes: ["tving"],
      planNote: "스탠다드 · LG U+ 유독",
      price: 12825,
      sourceLabel: "LG U+ 유독",
      sourceUrl: "https://www.lguplus.com/pogg/product/%EC%9C%A0%EB%8F%85-%ED%8B%B0%EB%B9%99-%EC%9B%94%EC%A0%95%EC%95%A1-%EC%9D%B4%EC%9A%A9%EA%B6%8C",
      evidence: "official",
    },
  ],
  pathGuides: [
    ...
    },
    {
      ...
      title: "통신사 결합·구독패스",
      summary:
        "SKT T 우주패스 티빙&웨이브, LG U+ 유독(디즈니+·티빙 할인)처럼 통신·구독 제휴가 있습니다. 상위 요금제에 묶이면 체감 단가가 더 낮아질 수 있어요.",
      when: "이미 해당 통신사를 쓰거나 요금제 변경·유독 가입을 검토할 때",
      action: "T world / KT 초이스·결합 / U+ 유독 공식에서 본인 요금제·할인 조건을 확인",
